        ...
        <form id="produto-update-{{ $produto?->id }}" wire:submit="save" class="space-y-6">
                <div class="grid md:grid-cols-12 gap-6 items-start">
                    ...
                    <div class="md:col-span-3 space-y-2">
                        <div>
                            @if ($imagemTemp)
                                <img src="{{ $imagemTemp->temporaryUrl() }}"
                    ...
                    <div class="md:col-span-9 space-y-4">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <x-input label="Data Validade *" type="date" wire:model="produto.data_validade"
                                required />
                        </div>
                        ...
                        <div class="grid md:grid-cols-3 gap-4">
                            ...
                            <x-select.native label="Tipo Produto *" wire:model="produto.tipo" :options="[['name' => 'Fisico', 'id' => 'F'], ['name' => 'Digital', 'id' => 'D']]"
                                select="label:name|value:id" required />
